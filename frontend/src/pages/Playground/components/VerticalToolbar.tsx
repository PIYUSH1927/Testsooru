...
const VerticalToolbar: React.FC<VerticalToolbarProps> = ({ onToolSelected }) => {
  ...
  const renderIcon = (item: { id: string, icon: string }) => {
    if (item.id === 'project') {
      ...
      return (
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M21 9V7c0-1.65-1.35-3-3-3H6C4.35 4 3 5.35 3 7v2c-1.65 0-3 1.35-3 3v5c0 1.65 1.35 3 3 3h18c1.65 0 3-1.35 3-3v-5c0-1.65-1.35-3-3-3zM6 7h12v2H6V7zm15 10H3v-5h2v3h14v-3h2v5z" fill="currentColor"/>
</svg>
      );

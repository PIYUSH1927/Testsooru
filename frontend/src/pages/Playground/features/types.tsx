...
export interface Point {
  ...
  export type ActiveTool = 'design' | 'build' | 'project' | 'info' | 'objects' | 'styleboards' | 'exports' | 'help' | 'colors';
  export type BuildTool = 'drawRoom' | 'drawWall' | 'placeDoors' | 'placeWindows' | null;
